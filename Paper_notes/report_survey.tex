...
\begin{Highlighting}[]
\CommentTok{# Areas}
\NormalTok{table.areas <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{sort}\NormalTok{(}\KeywordTok{table}\NormalTok{(}\KeywordTok{unlist}\NormalTok{(}\KeywordTok{strsplit}\NormalTok{(}\KeywordTok{as.character}\NormalTok{(x), }\StringTok{","}\NormalTok{))))}
\NormalTok{areas.list <-}\StringTok{ }\KeywordTok{split}\NormalTok{(QID12, QID4)}
\KeywordTok{pie}\NormalTok{(}\KeywordTok{table.areas}\NormalTok{(areas.list}\OperatorTok{$}\NormalTok{Female), }\DataTypeTok{main=}\KeywordTok{strnl}\NormalTok{(questions[}\StringTok{"QID12"}\NormalTok{]))}
\KeywordTok{mtext}\NormalTok{(}\StringTok{"Women"}\NormalTok{, }\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pie}\NormalTok{(}\KeywordTok{table.areas}\NormalTok{(areas.list}\OperatorTok{$}\NormalTok{Male), }\DataTypeTok{main=}\KeywordTok{strnl}\NormalTok{(questions[}\StringTok{"QID12"}\NormalTok{]))}
\KeywordTok{mtext}\NormalTok{(}\StringTok{"Men"}\NormalTok{, }\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
